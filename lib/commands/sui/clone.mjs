import { new_move_gen, clone_chain_move_module } from '@deepmove/sui';
...
Command.prototype.handle = async function (agent, comd, argv, rl, msg) {
    ...
    let module_objectid = argvs[2];

    await clone_chain_move_module(move_gen, network, module_objectid, package_path);
