...
// src/aptos/wasm/pkg/aptos_wasm_bg.js
var aptos_wasm_bg_exports = {};
__export(aptos_wasm_bg_exports, {
  AptosWasm: () => AptosWasm,
  ...
  __wbg_crypto_805be4ce92f1e370: () => __wbg_crypto_805be4ce92f1e370,
  __wbg_error_7534b8e9a36f1ab4: () => __wbg_error_7534b8e9a36f1ab4,
  __wbg_getRandomValues_f6a868620c8bab49: () => __wbg_getRandomValues_f6a868620c8bab49,
  __wbg_log_c222819a41e063d3: () => __wbg_log_c222819a41e063d3,
  __wbg_mkdirpSync_9f0d87f46287b396: () => __wbg_mkdirpSync_9f0d87f46287b396,
  __wbg_msCrypto_2ac4d17c4748234a: () => __wbg_msCrypto_2ac4d17c4748234a,
  __wbg_new_257476aa0afbee04: () => __wbg_new_257476aa0afbee04,
  ...
  __wbg_node_ecc8306b9857f33d: () => __wbg_node_ecc8306b9857f33d,
  __wbg_parse_def2e24ef1252aff: () => __wbg_parse_def2e24ef1252aff,
  __wbg_process_5cff2739921be718: () => __wbg_process_5cff2739921be718,
  __wbg_randomFillSync_d3c85af7e31cf1f8: () => __wbg_randomFillSync_d3c85af7e31cf1f8,
  __wbg_require_0c566c6f2eef6c79: () => __wbg_require_0c566c6f2eef6c79,
  ...
  __wbg_versions_a8e5a362e1f16442: () => __wbg_versions_a8e5a362e1f16442,
  __wbg_writeFileSync_4ee45bf33a3b768a: () => __wbg_writeFileSync_4ee45bf33a3b768a,
...
// src/aptos/wasm/pkg/snippets/aptos-wasm-c349b381dc9a372e/call-js.js
...
var AptosWasmFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_aptoswasm_free(ptr >>> 0, 1));
var AptosWasm = class _AptosWasm {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_AptosWasm.prototype);
    obj.__wbg_ptr = ptr;
    AptosWasmFinalization.register(obj, obj.__wbg_ptr, obj);
    return obj;
  }
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    AptosWasmFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_aptoswasm_free(ptr, 0);
  }
  /**
  ...
  new_bytes(bytes2, type_tag) {
    ...
    const ret = wasm.aptoswasm_new_bytes(this.__wbg_ptr, ptr0, len0, ptr1, len1);
   ...
   */
  static new_wasm() {
    const ret = wasm.aptoswasm_new_wasm();
    return _AptosWasm.__wrap(ret);
  }
  refresh_vm() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.aptoswasm_refresh_vm(retptr, this.__wbg_ptr);
  ...
  publish_module(binary) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.aptoswasm_publish_module(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
        throw takeObject(r0);
  ...
  setup_storage() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.aptoswasm_setup_storage(retptr, this.__wbg_ptr);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
        throw takeObject(r0);
  ...
  reset_gas_cost() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.aptoswasm_reset_gas_cost(retptr, this.__wbg_ptr);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
        throw takeObject(r0);
  ...
  get_gas_cost() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.aptoswasm_get_gas_cost(retptr, this.__wbg_ptr);
  ...
  get_gas_report() {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.aptoswasm_get_gas_report(retptr, this.__wbg_ptr);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
   ...
   * @returns {CallArgument}
   */
  serialized_signer(account_address) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      const ptr0 = passStringToWasm0(account_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.aptoswasm_serialized_signer(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      if (r2) {
  ...
  add_source_map(binary) {
    try {
      ...
      const ptr0 = passArray8ToWasm0(binary, wasm.__wbindgen_malloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.aptoswasm_add_source_map(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
        throw takeObject(r0);
  ...
  add_source_code(code) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.aptoswasm_add_source_code(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
        throw takeObject(r0);
  ...
  call_return_bcs(account_address, module2, _function, ty_args, args) {
    try {
      ...
      wasm.aptoswasm_call_return_bcs(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
var MoveGen = class _MoveGen {
  ...
  static toml_edit_dependencies(toml_string, key0, key1, key2, value1) {
    ...
    try {
      ...
      const len4 = WASM_VECTOR_LEN;
      wasm.movegen_toml_edit_dependencies(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
   ...
   * @returns {string}
   */
  static toml_edit_addresses(toml_string, key0, key1, value1) {
    let deferred6_0;
    let deferred6_1;
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      ...
      const ptr2 = passStringToWasm0(key1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
      const len2 = WASM_VECTOR_LEN;
      const ptr3 = passStringToWasm0(value1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
      const len3 = WASM_VECTOR_LEN;
      wasm.movegen_toml_edit_addresses(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
   ...
   * @returns {string}
   */
  get_module_dependencies(binary) {
    let deferred3_0;
    let deferred3_1;
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      const ptr0 = passArray8ToWasm0(binary, wasm.__wbindgen_malloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.movegen_get_module_dependencies(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_mkdirpSync_9f0d87f46287b396(arg0, arg1, arg2) {
  let deferred0_0;
  let deferred0_1;
  try {
    deferred0_0 = arg1;
...
function __wbg_new_257476aa0afbee04() {
...
function __wbg_writeFileSync_4ee45bf33a3b768a(arg0, arg1, arg2, arg3, arg4, arg5) {
  let deferred0_0;
  let deferred0_1;
  let deferred1_0;
  let deferred1_1;
...
// src/aptos/wasm/pkg/aptos_wasm.js
import fs2 from "fs";
import { dirname } from "node:path";
import { fileURLToPath } from "node:url";

// src/aptos/wasm/pkg/env.js
function set_env(imports) {
  ...
  imports["env"]["blst_p2_add_or_double_affine"] = function() {
  };
  imports["env"]["blst_p1_affine_compress"] = function() {
  };
  imports["env"]["blst_p1_add_or_double_affine"] = function() {
  };
  let envs = [
...
if (import.meta && import.meta.url) {
  bytes_dir = dirname(fileURLToPath(import.meta.url));
} else {
  bytes_dir = __dirname;
}
var bytes = fs2.readFileSync(bytes_dir + "/aptos_wasm_bg.wasm");
var wasmModule = new WebAssembly.Module(bytes);
var funcs = [];
for (k in aptos_wasm_bg_exports) {
  funcs.push(k);
}
var k;
var importObject = {
...
function afterTestAll(ctx) {
  ...
  for (var suite in gasRecords) {
    ...
    fs3.writeFileSync(out2, JSON.stringify(data, null, 2));
  }
  let gas_report_dir = process.cwd() + "/.tests/gas_report";
  if (!fs3.existsSync(gas_report_dir)) {
    fs3.mkdirpSync(gas_report_dir);
  }
  let out = gas_report_dir + `/${ctx.id}.json`;
  let gas_report = get_wasm().get_gas_report();
  fs3.writeFileSync(out, gas_report);
}
function get_gas_cost(name, suite) {
  let dir = process.cwd() + "/.tests/gas_cost";
  let out = dir + `/${suite}.json`;
  if (fs3.existsSync(out)) {
    let data = fs3.readFileSync(out).toString();
...
function get_gas_report(id) {
  ...
  if (fs3.existsSync(out)) {
    return fs3.readFileSync(out).toString();
  } else {
    return "";
  }
}
  ...
  try {
    for (var dep in deps_remotes) {
      ...
      if (dep_p["git"] && dep_p["subdir"] && dep_p["rev"]) {
        ...
        fs5.removeSync(git_dir);
        fs5.mkdirpSync(git_dir);
        shell.cd(git_dir);
        shell.exec("git init");
        ...
        if (dep_name == STD_NAME) {
          ...
          if (remote_subdir_final) {
            fs5.writeFileSync(sparse_checkout_path, remote_subdir_final);
          }
        } else {
          if (remote_subdir) {
            fs5.writeFileSync(sparse_checkout_path, `${remote_subdir}`);
          }
        }
    ...
    fs5.writeFileSync(toml_path, toml_string);
  } catch (e) {
    console.error(e);
  } finally {
...
function update_deps_toml(deps_toml_path, deps_std) {
  if (fs5.existsSync(deps_toml_path)) {
    let toml_string = fs5.readFileSync(deps_toml_path).toString();
    let toml = parse(toml_string);
    ...
    fs5.writeFileSync(deps_toml_path, result_toml_string);
  }
}
...
import { fromHex as fromHex2, toHex as toHex2 } from "@mysten/sui/utils";
var Signer = class _Signer {
  ...
  static get bcs() {
    ...
    if (wasm3.serialized_signer) {
      return bcs2.bytes(33).transform({
        input: (val) => wasm3.serialized_signer(val.into_value()).Raw[0],
        output: (val) => new _Signer(toHex2(val))
      });
    } else {
...
var Address = class _Address {
  ...
  static get bcs() {
    return bcs2.bytes(32).transform({
      // To change the input type, you need to provide a type definition for the input
      input: (val) => fromHex2(val.into_value()),
      output: (val) => new _Address(toHex2(val))
    });
  }
  get_bcs() {
    return _Address.bcs;
...
async function clone_chain_move_module(move_gen2, network, module_objectid, package_path) {
  ...
  let object_modules = {};
  await get_online_packages(move_gen2, network, module_objectid, object_modules, package_path);
  for (var objectid in object_modules) {
    ...
    if (!fs6.existsSync(out_bcs)) {
      fs6.mkdirpSync(out_bcs);
    }
    let out_bcs_file = `${out_bcs}/${objectid}.json`;
    fs6.writeFileSync(out_bcs_file, JSON.stringify(module_bcs, null, 2));
  }
  let toml_path = package_path + "/Move.toml";
  let toml_string = fs6.readFileSync(toml_path).toString();
  ...
  fs6.writeFileSync(toml_path, toml_string);
  console.log(`Clone move bytecodes of ${module_objectid} done!`);
}
async function get_online_packages(move_gen2, network, objectid, object_modules, package_path) {
  let out = package_path + "/deps";
  ...
  for (var dependencies_module in dependencies_modules) {
    if (!object_modules[dependencies_module]) {
      await get_online_packages(move_gen2, network, dependencies_module, object_modules, package_path);
...
function gen_move_toml(deps_modules, out, objectId) {
  ...
  if (!fs6.existsSync(out_dir)) {
    fs6.mkdirpSync(out_dir);
  }
  ...
  let move_toml_result = toml_stringify2(contents);
  fs6.writeFileSync(move_toml, move_toml_result);
}
...
function setup(runtime, package_path) {
  let toml_path = package_path + "/Move.toml";
  let toml_string = fs7.readFileSync(toml_path).toString();
  let toml = parse2(toml_string);
  ...
  for (var dep_module in toml.dependencies) {
    if (dep_module.startsWith("0x") && toml.dependencies[dep_module]["local"]) {
      ...
      if (fs7.existsSync(local_bcs_path)) {
        let bcs_json_files = fs7.readdirSync(local_bcs_path);
        for (var i = 0; i < bcs_json_files.length; i++) {
          let bcs_json_file = local_bcs_path + "/" + bcs_json_files[i];
          var bcs_json_data = fs7.readFileSync(bcs_json_file).toString();
          if (bcs_json_data) {
            var bcs_json = JSON.parse(bcs_json_data);
            for (var bcs_module in bcs_json) {
              runtime.publish_module(fromHex3(bcs_json[bcs_module]));
            }
          }
        }
      }
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    let bytes2 = fs7.readFileSync(files[i]);
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    let bytes2 = fs7.readFileSync(files[i]).toString();
...
function setup_move(runtime, package_path, include_deps) {
        ...
        if (fs7.existsSync(local_bcs_path)) {
          ...
          for (var i = 0; i < bcs_json_files.length; i++) {
            ...
            if (bcs_json_data) {
              var bcs_json = JSON.parse(bcs_json_data);
              for (var bcs_module in bcs_json) {
                runtime.register_module(bcs_json_module, fromHex3(bcs_json[bcs_module]));
              }
            }
          }
        }
  ...
  if (include_deps) {
    ...
    var dirfiles = fs7.readdirSync(bytecode_path);
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    var bytes2 = fs7.readFileSync(file);
...
// src/aptos/publish.ts
import { Account, Ed25519PrivateKey, PrivateKey, PrivateKeyVariants } from "@aptos-labs/ts-sdk";
import { stringify as yaml_stringify } from "yaml";
import { readDirDeepSync as readDirDeepSync2 } from "read-dir-deep";
import { parse as parse3 } from "smol-toml";
import shell2 from "shelljs";
import fs8 from "fs-extra";
function upgrade_move_module(aptos_bin_path, package_path, network, object_address) {
  ...
  console.log(cmd);
  let out = shell2.exec(cmd).stdout;
  let new_object_address = "";
...
function publish_move_module(aptos_bin_path, package_path, network) {
  set_aptos_yaml(package_path, network);
  let module_name = get_module_name(package_path);
  set_move_toml_addresses(module_name, package_path, "_");
...
function set_aptos_yaml(package_path, network) {
  let aptos_path = package_path + "/.aptos";
  if (!fs8.existsSync(aptos_path)) {
    fs8.mkdirpSync(aptos_path);
  }
  ...
  fs8.writeFileSync(yaml_path, yaml_string);
}
function set_move_toml_addresses(module_name, package_path, address) {
  let toml_path = package_path + "/Move.toml";
  let toml_string = fs8.readFileSync(toml_path).toString();
  let toml = parse3(toml_string);
  let addresses = toml.addresses;
  if (addresses[module_name] != address) {
    addresses[module_name] = address;
    toml.addresses = addresses;
    let toml_string2 = fs8.readFileSync(toml_path).toString();
    toml_string2 = MoveGen.toml_edit_addresses(toml_string2, "addresses", module_name, address);
    fs8.writeFileSync(toml_path, toml_string2);
  }
}
function get_module_name(package_path) {
  let sources_path = package_path + "/sources";
  let files = readDirDeepSync2(sources_path, { gitignore: false, ignore: [] });
  for (var i = 0; i < files.length; i++) {
    let move_code = fs8.readFileSync(files[i]).toString();
